...
常見問題為**哪些 IP 範圍容許通過防火牆？**。下列清單包含使用 Hardware Firewall (Dedicated) 的 IP 完整範圍。
...
## 服務網路（後端/專用網路）
請務必新增 DAL01、WDC04 及您伺服器位置的規則。如果您的伺服器是在 AMS01 中，您將需要新增容許 DAL01、WDC04 及 AMS01 資料流量的規則。
